    ...
    return function (originalConstructor) {
        return /** @class */ (function (_super) {
            ...
            function class_1() {
                ...
                var _this = _super.call(this, "Jhanvi") || this;
...
function propDecore(target, title) {
    // if(target.value === "Jhanvi")
    console.log(target.title, " ------------------------------------2------------------- ", title);
    // else
    // alert("!!!"+" "+target);
}
function setDecore(target, title, desc) {
    console.log("--------------------------3--------------------------");
    console.log(target);
    console.log(title);
    console.log(desc);
...
// @cls1Decore("START")
var propDecoreCls = /** @class */ (function () {
    function propDecoreCls(xyz) {
        this._about = "";
        this.title = xyz;
        console.log("con called!");
    }
    Object.defineProperty(propDecoreCls.prototype, "about", {
        set: function (str) {
            this._about = str;
        },
        enumerable: false,
    ...
    ], propDecoreCls.prototype, "title", void 0);
    __decorate([
        setDecore,
        __metadata("design:type", String),
        __metadata("design:paramtypes", [String])
    ], propDecoreCls.prototype, "about", null);
    return propDecoreCls;
}());
var decoreObj = new propDecoreCls("Jhanvi");
